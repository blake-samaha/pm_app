...
from exceptions import AuthorizationError, ResourceNotFoundError, DuplicateResourceError
...
class TestCreateProject:
    ...
    def test_duplicate_precursive_url_rejected(self, session, cogniter_user, sample_project):
...
class TestGetUserProjects:
    ...
    def test_client_sees_only_assigned_projects(self, session, client_user, sample_project):
...
class TestUserAssignment:
    ...
    def test_cogniter_can_assign_user(self, session, cogniter_user, client_user, sample_project):
...
class TestAccessControl:
    ...
    def test_cogniter_has_access_to_all_projects(self, session, cogniter_user, sample_project):
        """Cogniters should have access to all projects."""
        service = ProjectService(session)
        
        has_access = service.user_has_access_to_project(sample_project.id, cogniter_user)
        
        assert has_access is True
    
    def test_unassigned_client_has_no_access(self, session, client_user, sample_project):
