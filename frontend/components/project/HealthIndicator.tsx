...
export const HealthIndicator = ({ status, label, size = "md", variant = "subtle" }: HealthIndicatorProps) => {
  ...
  return (
    <div className={`flex items-center space-x-2 rounded-full border transition-all duration-200 ${style.bg} ${containerPadding[size]}`}>
